...
public class WordLadderII {
    ...
    public static List<List<String>> findLadders(String beginWord, String endWord, List<String> wordList) {
        ...
        List<String> idWord = new ArrayList<>(); // id到单词的映射
        int id = 0;
        ...
        // 初始化存边用的数组
        List<Integer>[] edges = new ArrayList[idWord.size()];  // 图的边
    ...
    private static boolean transformCheck(String str1, String str2) {
        int differences = 0;
